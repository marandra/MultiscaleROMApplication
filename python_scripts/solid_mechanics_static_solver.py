...
class StaticMechanicalSolver(solid_mechanics_solver.MechanicalSolver):
    ...
    def __init__(self, main_model_part, custom_settings): 
        ...
        self.mechanical_scheme = None
        self.mechanical_convergence_criterion = None
        self.builder_and_solver = None
        print("Construction of CUSTOM Static Mechanical Solver finished")
    ...
    def Initialize(self):
        ...
        self.mechanical_scheme = mechanical_scheme 
        
        # Get the convergence choice
        mechanical_convergence_criterion = self._GetConvergenceCriterion()
        self.mechanical_convergence_criterion = mechanical_convergence_criterion 
