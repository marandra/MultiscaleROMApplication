...
def update_energy_modes(energy_modes, reduced_energy_modes, integration_weights_filename, reduced_ip_set):
...
def compute_stress_reconstruction_system(reduced_ip_set, reduced_ip_weights, energy_modes, reduced_energy_modes):
...
def compute_system(rve_data_filename, energy_modes_filename, integration_weights_filename):
    ...
    energy_modes, reduced_energy_modes = update_energy_modes(energy_modes, reduced_energy_modes, integration_weights_filename, reduced_ip_set)
    A = compute_stress_reconstruction_system(reduced_ip_set, reduced_ip_weights, energy_modes, reduced_energy_modes)
    return A
