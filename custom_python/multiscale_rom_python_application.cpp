...
namespace Kratos {
    namespace Python {
        ...
        BOOST_PYTHON_MODULE(KratosMultiscaleROMApplication) {
            ...
            KRATOS_REGISTER_IN_PYTHON_VARIABLE(LAGRANGIAN_DOF_1)
            KRATOS_REGISTER_IN_PYTHON_VARIABLE(LAGRANGIAN_DOF_2)
            KRATOS_REGISTER_IN_PYTHON_VARIABLE(LAGRANGIAN_DOF_3)
        }
    }  // namespace Python.
}  // namespace Kratos.
