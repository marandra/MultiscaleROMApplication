...
PYBIND11_MODULE(KratosMultiscaleROMApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MODE_INDEX)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, CAUCHY_STRESS_VECTOR_LIST)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, STRAIN_ENERGY_VECTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, DAMAGE_VARIABLE_VECTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, GLOBAL_MODES_MATRIX)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, GLOBAL_INDEX_VECTOR)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, RHS_MATRIX)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, LHS_MATRIX)
