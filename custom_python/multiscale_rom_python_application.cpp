...
PYBIND11_MODULE(KratosMultiscaleROMApplication, m)
{
    ...
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MODE_NUMBER)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, MODES_MATRIX)
    KRATOS_REGISTER_IN_PYTHON_VARIABLE(m, ROM_MODES_MATRIX)
