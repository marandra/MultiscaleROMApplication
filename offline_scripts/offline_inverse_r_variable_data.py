...
def load_energy_modes(energy_modes_filename, reduced_ip_set):
    logger.info("Reading damage modes")
    ...
    print(reduced_ip_set)
    print(reduced_energy_modes)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description="Computes data necessary for later reconstruction of the damage")
    ...
    A = compute_system(args.rve_data, args.damage_modes, None)
    logger.info("Saving system")
    io_utilities.write_numpy_file('correlation_damage.npy', 'binary', A)
