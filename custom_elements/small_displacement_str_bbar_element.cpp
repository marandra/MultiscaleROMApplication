...
namespace Kratos
{
    SmallDisplacementStrBbarElement::SmallDisplacementStrBbarElement(IndexType NewId,
...
//************************************************************************************
    ...
    Element::Pointer SmallDisplacementStrBbarElement::Create(IndexType NewId,
                                                         NodesArrayType const& ThisNodes,
                                                         PropertiesType::Pointer pProperties) const
    {
        return Element::Pointer(new SmallDisplacementStrBbarElement(
                NewId, GetGeometry().Create(ThisNodes), pProperties));
    }

    SmallDisplacementStrBbarElement::~SmallDisplacementStrBbarElement()
    {
    }
...
//************************************************************************************
    ...
    void SmallDisplacementStrBbarElement::CalculateOnIntegrationPoints(const Variable<Matrix>& rVariable,
    ...
    void SmallDisplacementStrBbarElement::CalculateOnIntegrationPoints(const Variable<double>& rVariable,
    ...
    void SmallDisplacementStrBbarElement::CalculateOnIntegrationPoints(
...
//************************************************************************************
    ...
    void SmallDisplacementStrBbarElement::CalculateAll(
...
//************************************************************************************
    ...
    void SmallDisplacementStrBbarElement::CalculateAndAddResidualVector(
            VectorType& rRightHandSideVector,
...
//************************************************************************************
    ...
    void SmallDisplacementStrBbarElement::CalculateB(
            Matrix& rB,
            const Matrix& DN_DX,
    ...
    void SmallDisplacementStrBbarElement::CalculateKinematicVariables(
...
//************************************************************************************
    ...
    void SmallDisplacementStrBbarElement::CalculateKinematicVariablesBbar(
            KinematicVariables& rThisKinematicVariables,
            const unsigned int PointNumber,
            const GeometryType::IntegrationPointsArrayType& IntegrationPoints
    )
...
//************************************************************************************
//************************************************************************************
    void SmallDisplacementStrBbarElement::CalculateMatrixBbar(Matrix& rB,
            Vector& rBh,
...
//************************************************************************************
    ...
    void SmallDisplacementStrBbarElement::CalculateHydrostaticDeformationMatrix(KinematicVariables& rVariables)
    {
        KRATOS_TRY
            const unsigned int number_of_nodes = GetGeometry().PointsNumber();
            const unsigned int dimension = GetGeometry().WorkingSpaceDimension();
    ...
    void SmallDisplacementStrBbarElement::CalculateConstitutiveVariables(
            KinematicVariables& rThisKinematicVariables,
    ...
    void SmallDisplacementStrBbarElement::FinalizeSolutionStep( ProcessInfo& rCurrentProcessInfo )
    {
        // Create and initialize element variables:
        const unsigned int number_of_nodes = GetGeometry().size();
        const unsigned int dimension = GetGeometry().WorkingSpaceDimension();
...
//************************************************************************************
    ...
    void SmallDisplacementStrBbarElement::save(Serializer& rSerializer) const
    {
        rSerializer.save("Name", "SmallDisplacementStrBbarElement");
...
//************************************************************************************
    ...
    void SmallDisplacementStrBbarElement::load(Serializer& rSerializer)
    {
