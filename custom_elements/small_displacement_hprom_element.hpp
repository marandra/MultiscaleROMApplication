...
protected:
  ...
  public:
    ...
    void
    SetLeftHandSideMatrices(std::vector<MatrixType> &rLeftHandSideMatrices) {
      mpLeftHandSideMatrices = &rLeftHandSideMatrices;
    };
    void SetLeftHandSideVariables(
    ...
    void
    SetRightHandSideVectors(std::vector<VectorType> &rRightHandSideVectors) {
      mpRightHandSideVectors = &rRightHandSideVectors;
    };
    void SetRightHandSideVariables(
...
//  void GetSecondDerivativesVector(Vector &rValues, int Step = 0);
  ...
  */
   ...
   */
  void
  CalculateLocalSystem(std::vector<MatrixType> &rLeftHandSideMatrices,
   ...
   */
  void
  CalculateRightHandSide(std::vector<VectorType> &rRightHandSideVectors,
                         const std::vector<Variable<VectorType>> &rRHSVariables,
                         ProcessInfo &rCurrentProcessInfo);
   ...
   * identified by a variable rRHSVariable by assembling it to the nodes on the
   * variable
...
protected:
   ...
   */
  virtual void
  InitializeGeneralVariables(GeneralVariables &rVariables,
                             const ProcessInfo &rCurrentProcessInfo);
