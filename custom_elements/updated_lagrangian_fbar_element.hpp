...
public:
    ...
    /// Destructor.
    virtual ~UpdatedLagrangianFbarElement();
    ...
    /// Assignment operator.
    UpdatedLagrangianFbarElement& operator=(UpdatedLagrangianFbarElement const& rOther);
...
protected:
    ...
    ///@{
    UpdatedLagrangianFbarElement() : LargeDisplacementElement()
    {
    }
...
}; // Class UpdatedLagrangianFbarElement
