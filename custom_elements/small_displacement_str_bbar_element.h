...
#if !defined(KRATOS_SMALL_DISPLACEMENT_STR_BBAR_ELEMENT_H_INCLUDED )
#define  KRATOS_SMALL_DISPLACEMENT_STR_BBAR_ELEMENT_H_INCLUDED
 ...
 */
    ...
    class SmallDisplacementStrBbarElement
    ...
    public:
        ...
        KRATOS_CLASS_POINTER_DEFINITION(SmallDisplacementStrBbarElement);
        ...
        /// Default constructor.
        SmallDisplacementStrBbarElement(IndexType NewId, GeometryType::Pointer pGeometry);
        SmallDisplacementStrBbarElement(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties);

        /// Destructor.
        virtual ~SmallDisplacementStrBbarElement();
    ...
    protected:
        ...
        ///@{
        SmallDisplacementStrBbarElement() : SmallDisplacement()
        {
        }
...
#endif // KRATOS_SMALL_DISPLACEMENT_STR_BBAR_ELEMENT_H_INCLUDED defined
