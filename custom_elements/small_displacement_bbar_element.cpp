 ...
 */
KRATOS_CREATE_LOCAL_FLAG( SmallDisplacementBbarElement, COMPUTE_RHS_VECTOR,                 0 );
KRATOS_CREATE_LOCAL_FLAG( SmallDisplacementBbarElement, COMPUTE_LHS_MATRIX,                 1 );
KRATOS_CREATE_LOCAL_FLAG( SmallDisplacementBbarElement, COMPUTE_RHS_VECTOR_WITH_COMPONENTS, 2 );
KRATOS_CREATE_LOCAL_FLAG( SmallDisplacementBbarElement, COMPUTE_LHS_MATRIX_WITH_COMPONENTS, 3 );
...
SmallDisplacementBbarElement::SmallDisplacementBbarElement( IndexType NewId, GeometryType::Pointer pGeometry )
...
SmallDisplacementBbarElement::SmallDisplacementBbarElement( IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties )
...
Element::Pointer SmallDisplacementBbarElement::Create( IndexType NewId, NodesArrayType const& rThisNodes, PropertiesType::Pointer pProperties ) const
{
...
Element::Pointer SmallDisplacementBbarElement::Clone( IndexType NewId, NodesArrayType const& rThisNodes ) const
{
...
SmallDisplacementBbarElement::IntegrationMethod SmallDisplacementBbarElement::GetIntegrationMethod() const
{
...
void SmallDisplacementBbarElement::GetDofList( DofsVectorType& rElementalDofList, ProcessInfo& rCurrentProcessInfo )
{
...
void SmallDisplacementBbarElement::EquationIdVector( EquationIdVectorType& rResult, ProcessInfo& rCurrentProcessInfo )
{
...
void SmallDisplacementBbarElement::GetValuesVector( Vector& rValues, int Step )
{
    const unsigned int number_of_nodes = GetGeometry().size();
    const unsigned int dimension       = GetGeometry().WorkingSpaceDimension();
    unsigned int       element_size    = number_of_nodes * dimension;
...
void SmallDisplacementBbarElement::GetFirstDerivativesVector( Vector& rValues, int Step )
{
    const unsigned int number_of_nodes = GetGeometry().size();
    const unsigned int dimension       = GetGeometry().WorkingSpaceDimension();
    unsigned int       element_size    = number_of_nodes * dimension;
...
void SmallDisplacementBbarElement::GetSecondDerivativesVector( Vector& rValues, int Step )
{
    const unsigned int number_of_nodes = GetGeometry().size();
    const unsigned int dimension       = GetGeometry().WorkingSpaceDimension();
    unsigned int       element_size    = number_of_nodes * dimension;
...
void SmallDisplacementBbarElement::SetValueOnIntegrationPoints( const Variable<double>& rVariable,
...
void SmallDisplacementBbarElement::SetValueOnIntegrationPoints( const Variable<Vector>& rVariable,
...
void SmallDisplacementBbarElement::SetValueOnIntegrationPoints( const Variable<Matrix>& rVariable,
...
void SmallDisplacementBbarElement::SetValueOnIntegrationPoints( const Variable<ConstitutiveLaw::Pointer>& rVariable,
...
void SmallDisplacementBbarElement::GetValueOnIntegrationPoints( const Variable<double>& rVariable,
        std::vector<double>& rValues,
        const ProcessInfo& rCurrentProcessInfo )
{
...
void SmallDisplacementBbarElement::GetValueOnIntegrationPoints( const Variable<Vector>& rVariable,
        std::vector<Vector>& rValues,
        const ProcessInfo& rCurrentProcessInfo )
{
...
void SmallDisplacementBbarElement::GetValueOnIntegrationPoints( const Variable<Matrix>& rVariable,
        std::vector<Matrix>& rValues,
        const ProcessInfo& rCurrentProcessInfo )
{
...
void SmallDisplacementBbarElement::GetValueOnIntegrationPoints( const Variable<ConstitutiveLaw::Pointer>& rVariable,
        std::vector<ConstitutiveLaw::Pointer>& rValues,
        const ProcessInfo& rCurrentProcessInfo )
{
...
void SmallDisplacementBbarElement::Initialize()
{
    KRATOS_TRY
...
void SmallDisplacementBbarElement::SetGeneralVariables(GeneralVariables& rVariables,
...
void SmallDisplacementBbarElement::InitializeGeneralVariables (GeneralVariables & rVariables, const ProcessInfo& rCurrentProcessInfo)
{
...
void SmallDisplacementBbarElement::InitializeSystemMatrices(MatrixType& rLeftHandSideMatrix,
...

{
    ...
    if ( rCalculationFlags.Is(SmallDisplacementBbarElement::COMPUTE_LHS_MATRIX) ) //calculation of the matrix is required
    {
    ...
    if ( rCalculationFlags.Is(SmallDisplacementBbarElement::COMPUTE_RHS_VECTOR) ) //calculation of the matrix is required
    {
...
//************************************************************************************
//******************************************************* JLM aca esta quid del asunto

void SmallDisplacementBbarElement::CalculateElementalSystem( LocalSystemComponents& rLocalSystem,
							 ProcessInfo& rCurrentProcessInfo)
{
    ...
    this->SmallDisplacementBbarElement::CalculateHydrostaticDeformationMatrix(Variables.B, Variables.Bh, Variables.DN_DX);  //JLM ver como hacer esto
        ...
        for ( unsigned int PointNumber = 0; PointNumber < integration_points.size(); PointNumber++ )
    {
        ...
        if ( rLocalSystem.CalculationFlags.Is(SmallDisplacementBbarElement::COMPUTE_LHS_MATRIX) ) //calculation of the matrix is required
        {
        ...
        if ( rLocalSystem.CalculationFlags.Is(SmallDisplacementBbarElement::COMPUTE_RHS_VECTOR) ) //calculation of the vector is required
        {
...
void SmallDisplacementBbarElement::CalculateDynamicSystem( LocalSystemComponents& rLocalSystem,
						       ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY
...
void SmallDisplacementBbarElement::CalculateAndAddLHS(LocalSystemComponents& rLocalSystem, GeneralVariables& rVariables, double& rIntegrationWeight)
{

  //contributions of the stiffness matrix calculated on the reference configuration
  if( rLocalSystem.CalculationFlags.Is( SmallDisplacementBbarElement::COMPUTE_LHS_MATRIX_WITH_COMPONENTS ) )
    {
...
void SmallDisplacementBbarElement::CalculateAndAddRHS(LocalSystemComponents& rLocalSystem, GeneralVariables& rVariables, Vector& rVolumeForce, double& rIntegrationWeight)
{
    //contribution of the internal and external forces
    if( rLocalSystem.CalculationFlags.Is( SmallDisplacementBbarElement::COMPUTE_RHS_VECTOR_WITH_COMPONENTS ) )
    {
...
void SmallDisplacementBbarElement::CalculateAndAddDynamicLHS(MatrixType& rLeftHandSideMatrix, GeneralVariables& rVariables, ProcessInfo& rCurrentProcessInfo, double& rIntegrationWeight)
{
...
void SmallDisplacementBbarElement::CalculateAndAddDynamicRHS(VectorType& rRightHandSideVector, GeneralVariables& rVariables, ProcessInfo& rCurrentProcessInfo, double& rIntegrationWeight)
{
  KRATOS_TRY
...
double& SmallDisplacementBbarElement::CalculateIntegrationWeight(double& rIntegrationWeight)
{
    const unsigned int dimension = GetGeometry().WorkingSpaceDimension();
...
void SmallDisplacementBbarElement::CalculateRightHandSide( VectorType& rRightHandSideVector, ProcessInfo& rCurrentProcessInfo )
{
    //create local system components
    LocalSystemComponents LocalSystem;

    //calculation flags
    LocalSystem.CalculationFlags.Set(SmallDisplacementBbarElement::COMPUTE_RHS_VECTOR);
...
void SmallDisplacementBbarElement::CalculateRightHandSide( std::vector< VectorType >& rRightHandSideVectors, const std::vector< Variable< VectorType > >& rRHSVariables, ProcessInfo& rCurrentProcessInfo )
{
    //create local system components
    LocalSystemComponents LocalSystem;
    ...
    //calculation flags
    LocalSystem.CalculationFlags.Set(SmallDisplacementBbarElement::COMPUTE_RHS_VECTOR);
    LocalSystem.CalculationFlags.Set(SmallDisplacementBbarElement::COMPUTE_RHS_VECTOR_WITH_COMPONENTS);
...
void SmallDisplacementBbarElement::CalculateLeftHandSide( MatrixType& rLeftHandSideMatrix, ProcessInfo& rCurrentProcessInfo )
{
    //create local system components
    LocalSystemComponents LocalSystem;

    //calculation flags
    LocalSystem.CalculationFlags.Set(SmallDisplacementBbarElement::COMPUTE_LHS_MATRIX);
...
void SmallDisplacementBbarElement::CalculateLocalSystem( MatrixType& rLeftHandSideMatrix, VectorType& rRightHandSideVector, ProcessInfo& rCurrentProcessInfo )
{
    //create local system components
    LocalSystemComponents LocalSystem;
...
void SmallDisplacementBbarElement::CalculateLocalSystem( std::vector< MatrixType >& rLeftHandSideMatrices,
						     ...
						     ProcessInfo& rCurrentProcessInfo )
{
    ...
    //calculation flags
    LocalSystem.CalculationFlags.Set(SmallDisplacementBbarElement::COMPUTE_LHS_MATRIX_WITH_COMPONENTS);
    LocalSystem.CalculationFlags.Set(SmallDisplacementBbarElement::COMPUTE_RHS_VECTOR_WITH_COMPONENTS);
    ...
    LocalSystem.CalculationFlags.Set(SmallDisplacementBbarElement::COMPUTE_RHS_VECTOR);
    LocalSystem.CalculationFlags.Set(SmallDisplacementBbarElement::COMPUTE_LHS_MATRIX,false);
    ...
    LocalSystem.CalculationFlags.Set(SmallDisplacementBbarElement::COMPUTE_LHS_MATRIX,true);
...
void SmallDisplacementBbarElement::InitializeSolutionStep( ProcessInfo& rCurrentProcessInfo )
{
    ClearNodalForces();
...
////************************************************************************************
////************************************************************************************
void SmallDisplacementBbarElement::InitializeNonLinearIteration( ProcessInfo& rCurrentProcessInfo )
{
    ClearNodalForces();
}
...
void SmallDisplacementBbarElement::FinalizeNonLinearIteration( ProcessInfo& rCurrentProcessInfo )
{
...
void SmallDisplacementBbarElement::FinalizeSolutionStep( ProcessInfo& rCurrentProcessInfo )
{
    //create and initialize element variables:
    GeneralVariables Variables;
    this->InitializeGeneralVariables(Variables,rCurrentProcessInfo);
...
void SmallDisplacementBbarElement::InitializeMaterial()
{
    KRATOS_TRY
...
void SmallDisplacementBbarElement::ResetConstitutiveLaw()
{
    KRATOS_TRY
...
void SmallDisplacementBbarElement::CalculateAndAddExternalForces(VectorType& rRightHandSideVector,
...
void SmallDisplacementBbarElement::CalculateAndAddInternalForces(VectorType& rRightHandSideVector,
        GeneralVariables& rVariables,
        double& rIntegrationWeight)
{
    KRATOS_TRY
...
void SmallDisplacementBbarElement::CalculateAndAddKuum(MatrixType& rLeftHandSideMatrix,
        GeneralVariables& rVariables,
        double& rIntegrationWeight
                                                  )
{
...
void SmallDisplacementBbarElement::ClearNodalForces()
{
    KRATOS_TRY
...
void SmallDisplacementBbarElement::AddExplicitContribution(const VectorType& rRHSVector, 
...
void SmallDisplacementBbarElement::CalculateKinematics(GeneralVariables& rVariables,
...
Matrix& SmallDisplacementBbarElement::CalculateDeltaPosition(Matrix & rDeltaPosition)
{
    KRATOS_TRY
...
void SmallDisplacementBbarElement::CalculateDisplacementGradient(Matrix& rH,
        const Matrix& rDN_DX)
{
    KRATOS_TRY
...
void SmallDisplacementBbarElement::CalculateVelocityGradient(const Matrix& rDN_DX,
        Matrix& rDF )
{
    KRATOS_TRY
...
//************************************************************************************
//************************************************************************************
    void SmallDisplacementBbarElement::CalculateDeformationMatrix(Matrix& rB,
                                                              const Matrix& rDN_DX)
    {
        KRATOS_TRY
            const unsigned int number_of_nodes = GetGeometry().PointsNumber();
...
//************************************************************************************
//************************************************************** JLM aca calcula B
void SmallDisplacementBbarElement::CalculateDeformationMatrixBbar(Matrix& rB, Matrix& rBh,
        const Matrix& rDN_DX)   // JLM debe entrar rBh
{
    ...
    if( dimension == 2 )
    {
		...
		//Inicializar B de 3x8 (no  B1, B2, B3 y B4 de 3x2 )   NO
		//B1(0, 0) = rB(0, 0);
		//B1(1, 1) = rB(1, 1);
		//B2(0, 0) = rB(0, 2);
		//B2(1, 1) = rB(1, 3);
		...
		{
			//unsigned int index = 2 * i;
			rBn(0, i) = rBn(0, i) + 1 / 3 * rBh(0, i);
			rBn(1, i) = rBn(1, i) + 1 / 3 * rBh(1, i);
			rBn(2, i) = rBn(2, i) + 1 / 3 * rBh(2, i);
		}
...
//************************************************************************************
//***************************************************** JLM aca calcula B hidrostatica
void SmallDisplacementBbarElement::CalculateHydrostaticDeformationMatrix(Matrix& rB, Matrix& rBh,
	const Matrix& rDN_DX)
{
	KRATOS_TRY
	...
	for (unsigned int PointNumber = 0; PointNumber < integration_points.size(); PointNumber++)
	{
		...
		for (unsigned int i = 0; i < number_of_nodes*2; i++)
		{
			...
			rBh(0, i) = rBh(0, i) + ( rB(0, i) + rB(1, i) + rB(2, i) );
			rBh(1, i) = rBh(0, i);
			rBh(2, i) = rBh(0, i);
		}
...
double& SmallDisplacementBbarElement::CalculateTotalMass( double& rTotalMass, const ProcessInfo& rCurrentProcessInfo )
{
    KRATOS_TRY
...
Vector& SmallDisplacementBbarElement::CalculateVolumeForce( Vector& rVolumeForce, GeneralVariables& rVariables )
{
    KRATOS_TRY
...
void SmallDisplacementBbarElement::CalculateFirstDerivativesContributions(MatrixType& rLeftHandSideMatrix, VectorType& rRightHandSideVector, ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY
...
void SmallDisplacementBbarElement::CalculateSecondDerivativesContributions(MatrixType& rLeftHandSideMatrix, VectorType& rRightHandSideVector, ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY
...
void SmallDisplacementBbarElement::CalculateSecondDerivativesLHS(MatrixType& rLeftHandSideMatrix, ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY
...
void SmallDisplacementBbarElement::CalculateSecondDerivativesRHS(VectorType& rRightHandSideVector, ProcessInfo& rCurrentProcessInfo)
{
    KRATOS_TRY
...
void SmallDisplacementBbarElement::CalculateMassMatrix( MatrixType& rMassMatrix, ProcessInfo& rCurrentProcessInfo )
{
    KRATOS_TRY
...
void SmallDisplacementBbarElement::CalculateDampingMatrix( MatrixType& rDampingMatrix, ProcessInfo& rCurrentProcessInfo )
{
    KRATOS_TRY
...
void SmallDisplacementBbarElement::CalculateOnIntegrationPoints( const Variable<double>& rVariable, std::vector<double>& rOutput, const ProcessInfo& rCurrentProcessInfo )
{
...
void SmallDisplacementBbarElement::CalculateOnIntegrationPoints( const Variable<Vector>& rVariable, std::vector<Vector>& rOutput, const ProcessInfo& rCurrentProcessInfo )
{
...
void SmallDisplacementBbarElement::CalculateOnIntegrationPoints( const Variable<Matrix >& rVariable, std::vector< Matrix >& rOutput, const ProcessInfo& rCurrentProcessInfo )
{
    KRATOS_TRY
...
void SmallDisplacementBbarElement::DecimalCorrection(Vector& rVector)
{
    KRATOS_TRY
 ...
 */
int  SmallDisplacementBbarElement::Check( const ProcessInfo& rCurrentProcessInfo )
{
    KRATOS_TRY
