...
import KratosMultiphysics.StructuralMechanicsApplication as kstr
...
def create_solver_complete_model_part(model_part, parameters):
    ...
    ReadMaterials(RVE1_model_part, "matRVE1")
    rve1 = RVELaw(RVE1_model_part, settings_rve1)
    model_part.Properties[1].SetValue(CONSTITUTIVE_LAW, rve1)

    RVE2_model_part = km.ModelPart("RVE2")
    ReadMaterials(RVE2_model_part, "matRVE2")
    rve2 = RVELaw(RVE2_model_part, settings_rve2)
    model_part.Properties[2].SetValue(CONSTITUTIVE_LAW, rve2)
