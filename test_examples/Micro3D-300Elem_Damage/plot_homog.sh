...
plot 'homogenized_stress.dat' u 0:1 title 'case' w lp,
     './MatlabResults/ModifiedCurvesWithNoVolumeVoids/Micro2D-Plasticity.cur001' u 0:2 title 'MatlabReference' w lp;
"
...
plot 'homogenized_stress.dat' u 0:2 title 'case' w lp,
     './MatlabResults/ModifiedCurvesWithNoVolumeVoids/Micro2D-Plasticity.cur002' u 0:2 title 'MatlabReference' w lp;
"
...
plot 'homogenized_stress.dat' u 0:4 title 'case' w lp,
     './MatlabResults/ModifiedCurvesWithNoVolumeVoids/Micro2D-Plasticity.cur003' u 0:2 title 'MatlabReference' w lp;
"
