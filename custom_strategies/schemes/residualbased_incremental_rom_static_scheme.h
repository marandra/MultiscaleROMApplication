...
class ResidualBasedIncrementalROMStaticScheme
    : public ResidualBasedIncrementalUpdateStaticScheme<TSparseSpace,
                                                        TDenseSpace> {
public:
  ...
  typedef ResidualBasedIncrementalUpdateStaticScheme<TSparseSpace, TDenseSpace>
      BaseType;
  ...
  virtual void Initialize(ModelPart &r_model_part) {
    ...
    r_model_part.GetProcessInfo().SetValue(REDUCED_MODES_WEIGHTS,
                                           modes_weights);
  }
...
private:
  /// Assignment operator.
  ResidualBasedIncrementalROMStaticScheme &
  operator=(ResidualBasedIncrementalROMStaticScheme const &rOther) {}

  /// Copy constructor.
  ResidualBasedIncrementalROMStaticScheme(
      ResidualBasedIncrementalROMStaticScheme const &rOther) {}
