...
#if !defined(KRATOS_RESIDUALBASED_NEWTON_RAPHSON_DENSE_STRATEGY )
#define  KRATOS_RESIDUALBASED_NEWTON_RAPHSON_DENSE_STRATEGY
...
template<class TSparseSpace,
         ...
         >
class ResidualBasedNewtonRaphsonDenseStrategy
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(ResidualBasedNewtonRaphsonDenseStrategy);
        ...
        : SolvingStrategy<TSparseSpace, TDenseSpace, TLinearSolver>(model_part, MoveMeshFlag)
    {
        ...
        mpA = TDenseSpace::CreateEmptyMatrixPointer();
        mpDx = TDenseSpace::CreateEmptyVectorPointer();
        mpb = TDenseSpace::CreateEmptyVectorPointer();
    ...
    virtual ~ResidualBasedNewtonRaphsonDenseStrategy()
    {
        Clear();
    }
    ...
    virtual void Predict() override
    {
        ...
        LocalSystemMatrixType& A = *mpA;
        LocalSystemVectorType& Dx = *mpDx;
        LocalSystemVectorType& b = *mpb;
    ...
    virtual void Clear() override
    {
        ...
        if (mpA != nullptr)
            ...
            //TODO commented out
            //TDenseSpace::Clear(mpA);
        if (mpDx != nullptr)
            //SparseSpaceType::Clear(mpDx);
            //TODO commented out
            //TDenseSpace::Clear(mpDx);
        if (mpb != nullptr)
            //SparseSpaceType::Clear(mpb);
            //TODO commented out
            //TDenseSpace::Clear(mpb);
    ...
    virtual bool SolveSolutionStep() override
    {
        ...
        if (BaseType::mRebuildLevel > 1 || BaseType::mStiffnessMatrixIsBuilt == false)
        {
            ...
            TDenseSpace::SetToZero(A);
            TDenseSpace::SetToZero(Dx);
            TDenseSpace::SetToZero(b);

            pBuilderAndSolver->BuildAndSolve(pScheme, BaseType::GetModelPart(), A, Dx, b);
        }
        else
        {
            TDenseSpace::SetToZero(Dx); //Dx=0.00;
            TDenseSpace::SetToZero(b);
...
//     TSystemMatrixType mA;
    ...
    LocalSystemMatrixType* mpA;
    LocalSystemVectorType* mpb;
    LocalSystemVectorType* mpDx;
...
//             std::cout << "After first system solution" << std::endl;
    ...
    ResidualBasedNewtonRaphsonDenseStrategy(const ResidualBasedNewtonRaphsonDenseStrategy& Other)
    {
    };
...
#endif /* KRATOS_RESIDUALBASED_NEWTON_RAPHSON_DENSE_STRATEGY  defined */
