...
public:
    ...
    /* Constructor. */
    ResidualBasedROMBuilderAndSolver(typename TLinearSolver::Pointer pNewLinearSystemSolver)
               ...
               TSystemVectorType& b)
    {
        ...
        for (int k = 0; k < nelements; k++)
        {
            ...
            pScheme->CalculateSystemContributions(*(it.base()), LHS_Contribution, RHS_Contribution,
...
#pragma omp parallel for firstprivate(nconditions, ids)
        ...
        A = boost::numeric::ublas::compressed_matrix<double>(
