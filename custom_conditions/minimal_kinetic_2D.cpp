...
Condition::Pointer MinimalKineticCondition2D::Create(IndexType NewId,
                                                     NodesArrayType const& ThisNodes,
                                                     PropertiesType::Pointer pProperties) const
{
    return MinimalKineticCondition2D::Pointer(new MinimalKineticCondition2D(
...
void MinimalKineticCondition2D::CalculateLocalSystem(MatrixType& rLeftHandSideMatrix,
...
void MinimalKineticCondition2D::CalculateLeftHandSide(MatrixType& rLeftHandSideMatrix,
                                                      ProcessInfo& rCurrentProcessInfo)
{
    rLeftHandSideMatrix.resize(0, 0, false);
}

void MinimalKineticCondition2D::CalculateRightHandSide(VectorType& rRightHandSideVector,
                                                       ProcessInfo& rCurrentProcessInfo)
{
    MatrixType dummy;
...
void MinimalKineticCondition2D::EquationIdVector(EquationIdVectorType& rResult,
                                                 ProcessInfo& rCurrentProcessInfo)
{
...
void MinimalKineticCondition2D::GetDofList(DofsVectorType& rConditionDofList,
                                           ProcessInfo& rCurrentProcessInfo)
{
    GeometryType& geom = GetGeometry();
