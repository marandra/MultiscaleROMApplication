...
namespace Kratos
{
    ...
    //******************************CONSTRUCTOR*******************************************
    //************************************************************************************
    //MinimalKineticCondition3D::MinimalKineticCondition3D(IndexType NewId, const NodesArrayType& ThisNodes):
    ...
    //******************************COPY CONSTRUCTOR**************************************
    //************************************************************************************
    MinimalKineticCondition3D::MinimalKineticCondition3D(IndexType NewId, GeometryType::Pointer pGeometry, PropertiesType::Pointer pProperties):
    ...
    //*********************************OPERATIONS*****************************************
    //************************************************************************************
    Condition::Pointer MinimalKineticCondition3D::Create(IndexType NewId, NodesArrayType const& ThisNodes, PropertiesType::Pointer pProperties) const
    {
        return MinimalKineticCondition3D::Pointer(new MinimalKineticCondition3D(NewId, GetGeometry().Create(ThisNodes), pProperties));
    }
    ...
    void MinimalKineticCondition3D::CalculateLocalSystem(MatrixType& rLeftHandSideMatrix, VectorType& rRightHandSideVector, ProcessInfo& rCurrentProcessInfo)
    {
        ...
        // Local assembly integral of shape functions matrix (for computing constraint matrix - multiscale cases)
    ...
    //************************************************************************************
    // Compute the integral of the shape functions within the finite element (for 3D cases)
    //************************************************************************************
    void MinimalKineticCondition3D::CalculateIntegralOfShapeFunctions(MatrixType& rNintMatrix, ProcessInfo& rCurrentProcessInfo)
    {
        KRATOS_TRY
...
*/
    ...
    void MinimalKineticCondition3D::CalculateLeftHandSide(MatrixType& rLeftHandSideMatrix, ProcessInfo& rCurrentProcessInfo)
    {
        rLeftHandSideMatrix.resize(0,0,false);
    }

    void MinimalKineticCondition3D::CalculateRightHandSide(VectorType& rRightHandSideVector, ProcessInfo& rCurrentProcessInfo)
    {
        MatrixType dummy;
        CalculateLocalSystem(dummy,rRightHandSideVector,rCurrentProcessInfo);
    }

    void MinimalKineticCondition3D::EquationIdVector(EquationIdVectorType& rResult, ProcessInfo& rCurrentProcessInfo)
    {
        ...
        unsigned int n_dofs = dimension * number_of_nodes + 6;  // 6 = Num components of (u_fl tens n)^s
    ...
    void MinimalKineticCondition3D::GetDofList(DofsVectorType& rConditionDofList, ProcessInfo& rCurrentProcessInfo)
    {
        GeometryType& geom = GetGeometry();
    ...
    void MinimalKineticCondition3D::InitializeGeneralVariables(GeneralVariables& rVariables, const ProcessInfo& rCurrentProcessInfo)
    {
