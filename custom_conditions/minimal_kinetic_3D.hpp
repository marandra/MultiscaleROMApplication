 ...
 */
class KRATOS_API(MULTISCALE_ROM_APPLICATION) MinimalKineticCondition3D : public Condition
{
public:
    ///@name Type Definitions
    ///@{
    ...
    ///array_1d<double, 3>& a, const array_1d<double, 3>& b);
...
inline std::istream& operator>>(std::istream& rIStream, MinimalKineticCondition3D& rThis)
{
    return rIStream;
}

/// output stream function
inline std::ostream& operator<<(std::ostream& rOStream, const MinimalKineticCondition3D& rThis)
{
