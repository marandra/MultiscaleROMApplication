...
namespace Kratos
{
	...
	*/
	class KRATOS_API(MULTISCALE_ROM_APPLICATION) SmallDisplacementIsotropicDamage3DLaw : public ConstitutiveLaw

	{

	public:

		KRATOS_CLASS_POINTER_DEFINITION(SmallDisplacementIsotropicDamage3DLaw);
	...
	//public:
		...
		* Destructor.
		*/
		virtual ~SmallDisplacementIsotropicDamage3DLaw(){};
	...
	}; /* class SmallDisplacementIsotropicDamage3DLaw */
} /* namespace Kratos */
