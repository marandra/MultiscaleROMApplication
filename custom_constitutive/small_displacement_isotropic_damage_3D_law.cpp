...
bool SmallDisplacementIsotropicDamage3DLaw::Has(const Variable<array_1d<double, 2>>& rThisVariable)
{
    return false;
}

bool SmallDisplacementIsotropicDamage3DLaw::Has(const Variable<array_1d<double, 3>>& rThisVariable)
{
    return false;
}

// New method -  for 3D cases
// bool SmallDisplacementIsotropicDamage3DLaw::Has(const
...
array_1d<double, 2>& SmallDisplacementIsotropicDamage3DLaw::GetValue(
    const Variable<array_1d<double, 2>>& rVariable, array_1d<double, 2>& rValue)
{
    return rValue;
}

array_1d<double, 3>& SmallDisplacementIsotropicDamage3DLaw::GetValue(
...
// array_1d<double, 6 > & SmallDisplacementIsotropicDamage3DLaw::GetValue(const
...
void SmallDisplacementIsotropicDamage3DLaw::SetValue(const Variable<array_1d<double, 2>>& rVariable,
                                                     const array_1d<double, 2>& rValue,
                                                     const ProcessInfo& rCurrentProcessInfo)
{
}

void SmallDisplacementIsotropicDamage3DLaw::SetValue(const Variable<array_1d<double, 3>>& rVariable,
...
// New Method - for 3D cases (check definition in the kratos core structure)
// void SmallDisplacementIsotropicDamage3DLaw::SetValue(const
...
void SmallDisplacementIsotropicDamage3DLaw::InitializeMaterial(const Properties& material_prop,
...
void SmallDisplacementIsotropicDamage3DLaw::InitializeSolutionStep(
...
void SmallDisplacementIsotropicDamage3DLaw::FinalizeSolutionStep(
    const Properties& rMaterialProperties,
    const GeometryType& rElementGeometry,
    const Vector& rShapeFunctionsValues,
    const ProcessInfo& rCurrentProcessInfo)
...
void SmallDisplacementIsotropicDamage3DLaw::InitializeNonLinearIteration(
    const Properties& rMaterialProperties,
    const GeometryType& rElementGeometry,
    const Vector& rShapeFunctionsValues,
    const ProcessInfo& rCurrentProcessInfo)
...
void SmallDisplacementIsotropicDamage3DLaw::FinalizeNonLinearIteration(
    const Properties& rMaterialProperties,
    const GeometryType& rElementGeometry,
    const Vector& rShapeFunctionsValues,
    const ProcessInfo& rCurrentProcessInfo)
...
void SmallDisplacementIsotropicDamage3DLaw::CalculateMaterialResponsePK1(Parameters& rValues)
{
    CalculateMaterialResponseCauchy(rValues);
}

void SmallDisplacementIsotropicDamage3DLaw::CalculateMaterialResponsePK2(Parameters& rValues)
{
    CalculateMaterialResponseCauchy(rValues);
}

void SmallDisplacementIsotropicDamage3DLaw::CalculateMaterialResponseKirchhoff(Parameters& rValues)
{
    CalculateMaterialResponseCauchy(rValues);
}

void SmallDisplacementIsotropicDamage3DLaw::CalculateMaterialResponseCauchy(Parameters& rValues)
{
...
void SmallDisplacementIsotropicDamage3DLaw::FinalizeMaterialResponsePK1(Parameters& rValues)
{
    FinalizeMaterialResponseCauchy(rValues);
}

void SmallDisplacementIsotropicDamage3DLaw::FinalizeMaterialResponsePK2(Parameters& rValues)
{
    FinalizeMaterialResponseCauchy(rValues);
}

void SmallDisplacementIsotropicDamage3DLaw::FinalizeMaterialResponseKirchhoff(Parameters& rValues)
{
    FinalizeMaterialResponseCauchy(rValues);
}

void SmallDisplacementIsotropicDamage3DLaw::FinalizeMaterialResponseCauchy(Parameters& rValues)
{
}
...
double SmallDisplacementIsotropicDamage3DLaw::CalculateQ(double r, const Properties& material_prop)
{
...
void SmallDisplacementIsotropicDamage3DLaw::CalculateConstitutiveMatrix(const Properties& props,
...
int SmallDisplacementIsotropicDamage3DLaw::Check(const Properties& rMaterialProperties,
                                                 const GeometryType& rElementGeometry,
                                                 const ProcessInfo& rCurrentProcessInfo)
{
