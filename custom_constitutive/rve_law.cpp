...
namespace Kratos
{
   ...
   // }
   //
   // double& RVELaw::GetValue(const Variable<double>& rThisVariable, double& rValue)
   // {
   // 	return rValue;
   // }
   //
   ...
   // }
   //
   // Matrix& RVELaw::GetValue(const Variable<Matrix>& rThisVariable, Matrix& rValue)
   // {
   // 	return rValue;
   // }
   //
   // array_1d<double, 2 > & RVELaw::GetValue(const Variable<array_1d<double, 2 > >& rVariable, array_1d<double, 2 > & rValue)
   // {
   // 	return rValue;
   // }
   //
   // array_1d<double, 3 > & RVELaw::GetValue(const Variable<array_1d<double, 3 > >& rVariable, array_1d<double, 3 > & rValue)
   // {
   // 	return rValue;
   // }
   //
...
//	r_prev = r;
   // }
   //
   // void RVELaw::InitializeNonLinearIteration(const Properties& rMaterialProperties,
   // 	const GeometryType& rElementGeometry,
   // 	const Vector& rShapeFunctionsValues,
   // 	const ProcessInfo& rCurrentProcessInfo)
   // {
   // }
   //
   // void RVELaw::FinalizeNonLinearIteration(const Properties& rMaterialProperties,
   // 	const GeometryType& rElementGeometry,
   // 	const Vector& rShapeFunctionsValues,
   // 	const ProcessInfo& rCurrentProcessInfo)
   // {
...
//	D *= Ebar / (1. - nubar * nubar);
   ...
   // 		    KRATOS_THROW_ERROR(std::invalid_argument, "RVELaw - missing YOUNG_MODULUS", "");
   // 		if(!rMaterialProperties.Has(POISSON_RATIO))
   // 		    KRATOS_THROW_ERROR(std::invalid_argument, "RVELaw - missing POISSON_RATIO", "");
   // 		if(!rMaterialProperties.Has(ISOTROPIC_DAMAGE_MODULUS))
   // 		KRATOS_THROW_ERROR(std::invalid_argument, "RVELaw - missing ISOTROPIC_DAMAGE_MODULUS", "");
   // 		if(!rMaterialProperties.Has(INFINITY_YIELD_STRESS))
   // 		KRATOS_THROW_ERROR(std::invalid_argument, "RVELaw - missing INFINITY_YIELD_STRESS", "");
   // 		if(rMaterialProperties[INFINITY_YIELD_STRESS] < 0)
   // 		    KRATOS_THROW_ERROR(std::invalid_argument, "RVELaw - INFINITY_YIELD_STRESS must be positive", "");
   // 		return 0;
   // }
