#if !defined (KRATOS_HOMOGENIZED_RVE_RESPONSE_2D_H_INCLUDED)
#define  KRATOS_HOMOGENIZED_RVE_RESPONSE_2D_H_INCLUDED
...
namespace Kratos
{
	...
	*/
	class KRATOS_API(MULTISCALE_ROM_APPLICATION) HomogenizedRVEResponse2D : public ConstitutiveLaw

	{

	public:

		KRATOS_CLASS_POINTER_DEFINITION(HomogenizedRVEResponse2D);
	...
	//public:
		...
		* Destructor.
		*/
		virtual ~HomogenizedRVEResponse2D(){};

		/**
		* Clone function (has to be implemented by any derived class)
		* @return a pointer to a new instance of this constitutive law
		* NOTE: implementation scheme:
		*      ConstitutiveLaw::Pointer p_clone(new IsotropicDamageHardeningPlaneStrain2DLaw());
		*      return p_clone;
		*/
