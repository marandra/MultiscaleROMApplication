...
namespace Kratos
{
class KRATOS_API(MULTISCALE_ROM_APPLICATION) RVEIdentifierLaw : public ConstitutiveLaw
{
protected:
...
public:
    ...
    KRATOS_CLASS_POINTER_DEFINITION(RVEIdentifierLaw);
     ...
     * Default constructor.
     */
    RVEIdentifierLaw(ModelPart::Pointer mpModelPart, Kratos::Parameters param);
