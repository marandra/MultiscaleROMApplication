#if !defined(KRATOS_SMALL_DISPLACEMENT_ISOTROPIC_ELASTIC_3D_LAW_H_INCLUDED)
#define KRATOS_SMALL_DISPLACEMENT_ISOTROPIC_ELASTIC_3D_LAW_H_INCLUDED
...
*/
class KRATOS_API(MULTISCALE_ROM_APPLICATION) LinearIsotropicElastic3DLaw
    : public ConstitutiveLaw

{
public:
    KRATOS_CLASS_POINTER_DEFINITION(LinearIsotropicElastic3DLaw);
    ...
    * Constructor.
    */
    LinearIsotropicElastic3DLaw();

    // Copy constructor
    LinearIsotropicElastic3DLaw(const LinearIsotropicElastic3DLaw &);

    /**
    * Destructor.
    */
    virtual ~LinearIsotropicElastic3DLaw(){};
...
}; /* class LinearIsotropicElastic3DLaw */
} /* namespace Kratos */
