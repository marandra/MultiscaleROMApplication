...
*/
class KRATOS_API(MULTISCALE_ROM_APPLICATION) LinearJ2PlasticityPlaneStrain2DLaw
    : public ConstitutiveLaw

{
public:
    KRATOS_CLASS_POINTER_DEFINITION(LinearJ2PlasticityPlaneStrain2DLaw);
    ...
    * Constructor.
    */
    LinearJ2PlasticityPlaneStrain2DLaw();

    /**
    * Destructor.
    */
    virtual ~LinearJ2PlasticityPlaneStrain2DLaw(){};
