...
def create_case_dir(traj_name, training_path, strain):
    ...
    # populate case dir
    create_properties_file("ProjectParameters.json", training_path, traj_name, case_path, strain)
...
if __name__ == "__main__":
    ...
    with open(strain_set_fname, "r") as fi:
        ...
        nr_id = len(str(nr_cases - 1)) #  size of the case number string (e.g. nr_cases=100, id: 00..99, nr_id=2)
