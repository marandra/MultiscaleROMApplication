...
def create_solver_complete_model_part(model_part, parameters):
    ...
    solver.AddDofs()
    lmutility = msr.LagrangeMultiplierUtility(model_part)
    lmutility.Execute()
    model_part.Nodes[0].AddDof(msr.LAGRANGE_MULTIPLIER_1)
    model_part.Nodes[0].AddDof(msr.LAGRANGE_MULTIPLIER_2)
    model_part.Nodes[0].AddDof(msr.LAGRANGE_MULTIPLIER_3)
    model_part.Nodes[0].AddDof(msr.LAGRANGE_MULTIPLIER_4)
    model_part.Nodes[0].AddDof(msr.LAGRANGE_MULTIPLIER_5)
    model_part.Nodes[0].AddDof(msr.LAGRANGE_MULTIPLIER_6)
...
#model_part.ProcessInfo[msr.LAGRANGE_MULTIPLIER_NODE] = model_part.Nodes[1]
#model_part.ProcessInfo[msr.LAGRANGE_MULTIPLIER_NODE] = model_part.Nodes()(1)
