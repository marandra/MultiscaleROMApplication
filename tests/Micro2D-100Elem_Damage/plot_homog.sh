...
plot 'homogenized_stress.dat' u 0:1 title 'case' w lp,
     './MatlabResults/Micro2D_100Elements.cur001' u 0:2 title 'MatlabReference' w lp;
"
...
plot 'homogenized_stress.dat' u 0:2 title 'case' w lp,
     './MatlabResults/Micro2D_100Elements.cur002' u 0:2 title 'MatlabReference' w lp;
"
...
plot 'homogenized_stress.dat' u 0:3 title 'case' w lp,
     './MatlabResults/Micro2D_100Elements.cur003' u 0:2 title 'MatlabReference' w lp;
"
