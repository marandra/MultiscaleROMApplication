...
kratos_benchmarking_path = '/home/manuel/Project/Kratos/benchmarking'  # kratos_root/benchmarking
...
def WriteBenchmarkResults(model_part):
    ...
    if (benchmarking.InBenchmarkingMode()):
        ...
        ref_Node = 66
        ref_Displacement = model_part.Nodes[ref_Node].GetSolutionStepValue(DISPLACEMENT_X)
        ...
        benchmarking.Output(ref_Displacement, "DISPLACEMENT_X", abs_tol, rel_tol)
